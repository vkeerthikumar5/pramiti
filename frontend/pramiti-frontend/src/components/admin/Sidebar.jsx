...
export default function Sidebar({ activeTab, onTabChange }) {
  ...
  const menuItems = [
    ...
    { key: "members", label: "Members", icon: <FaClipboardList /> },
  ...
  className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 fixed top-4 left-4 z-50"
>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto flex flex-col">
          ...
          <div className="h-32 flex items-center justify-center">
            <h1 className="text-2xl text-violet-800 font-bold px-3 py-2 rounded">
              Pramiti
            </h1>
          </div>
  ...
  className={`flex items-center gap-2 p-2 rounded hover:bg-violet-700/80 w-full ${
    activeTab === item.key ? "bg-violet-700/80" : ""
  }`}
>
